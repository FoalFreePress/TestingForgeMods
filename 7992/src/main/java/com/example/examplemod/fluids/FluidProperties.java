...
public class FluidProperties {
    ...
    public static final Properties FAST_WATER = new Properties(ModdedFluids.FAST_WATER, ModdedFluids.FAST_WATER_FLOWING, FluidAttributi.FAST_WATER).bucket(ModdedItems.FAST_WATER_BUCKET).block(ModdedBlocks.FAST_WATER_BLOCK).canMultiply(Predicates.CanMultiply.ALWAYS);
    ...
    public static final Properties FAST_LAVA = new Properties(ModdedFluids.FAST_LAVA, ModdedFluids.FAST_LAVA_FLOWING, FluidAttributi.FAST_LAVA).bucket(ModdedItems.FAST_LAVA_BUCKET).block(ModdedBlocks.FAST_LAVA_BLOCK).canMultiply(Predicates.CanMultiply.ALWAYS);
    ...
    public static final Properties FAST_GAS_NO_DROWN = new Properties(ModdedFluids.FAST_GAS_NO_DROWN, ModdedFluids.FAST_GAS_NO_DROWN_FLOWING, FluidAttributi.FAST_GAS_NO_DROWN).bucket(ModdedItems.FAST_GAS_NO_DROWN_BUCKET).block(ModdedBlocks.FAST_GAS_NO_DROWN_BLOCK).canMultiply(Predicates.CanMultiply.ALWAYS);
    ...
    public static final Properties FAST_GAS_DROWN = new Properties(ModdedFluids.FAST_GAS_DROWN, ModdedFluids.FAST_GAS_DROWN_FLOWING, FluidAttributi.FAST_GAS_DROWN).bucket(ModdedItems.FAST_GAS_DROWN_BUCKET).block(ModdedBlocks.FAST_GAS_DROWN_BLOCK).canMultiply(Predicates.CanMultiply.ALWAYS);
